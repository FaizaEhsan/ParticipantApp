...
export const textMonthFontWeight = '700';
...
export const selectedDayBackgroundColor = '#de3326';
export const selectedDayTextColor = '#fff';
export const todayBackgroundColor = '#de3326';
export const todayTextColor = '#fff';
